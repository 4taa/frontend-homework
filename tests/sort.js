...
QUnit.module('Тестируем функцию sort', function () {
	...
	QUnit.test('Функция работает правильно', function (assert) {
		...
		assert.strictEqual(sort('Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmodtempor incididunt ut labore et dolore magna aliqua'),
								'Aagmn Aailqu Abelor Acdgiiiinps Aemt Cceenorsttu Cddiiinntu Deeimmooprstu Deloor Des Dloor Do Eilt Elmor Et Impsu Ist Tu');
	});
});
